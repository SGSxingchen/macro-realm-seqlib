...
TRPG「宏观界域」的强化序列资料库，收录职业、特质改造、技能表、能量池、公共建筑等游戏资源，当前版本 **V6.6.1**，共 **724** 个资源文件。
...
| 文件 | 说明 |
|------|------|
| `宏观界域强化序列库V6.6.1.chm` | Windows CHM 帮助文档，支持全文检索，推荐使用 |
| `宏观界域强化序列库V6.6.1.zip` | 完整资源包（含序列库 + 荣誉室 + 更新日志） |
